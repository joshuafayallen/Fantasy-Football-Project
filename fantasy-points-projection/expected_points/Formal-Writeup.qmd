...
Additionally, while there is no technical upperbound to the number of touchdowns you could score in a game or a season. However, there are some practical bounds on the total number of touchdowns. The current single season record is held by Randy Moss with 23 a record that is `r 2025 - 2007` years old which broke Jerry Rice's single season record of 22 which was `r 2007-1987`. The current single game record is a three way tie between Kellen Winslow, Bob Shaw, and Jerry Rice with each player having 5 receiving touchdowns in a single game. No receiver since Jerry Rice in 1990 has had 5 receiving touchdowns in a game. 
