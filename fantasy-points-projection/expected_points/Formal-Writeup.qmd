...
In part, this is going to be more of a series of notes on what led me to some of the modeling decisions and how I came to them, as well as me learning more about football! The final goal is to have a few good predictive Bayesian models to help spot some value on the waiver wire and get a full-stack portfolio project. 

# Receiving

Receiver production can be bucketed into a few different worlds. For lack of a terminology, I conceive of receiving production in three ways: touchdown production, catch production, and what happens after they catch the ball.  As an illustrative example of what I mean by catch production, let's say that Josh Allen completes a pass 50 yards, and the receiver is immediately tackled.  The receiving yards on that play would be recorded as $\approx$ 50 yards. This is different than if Josh Allen throws a ball 5 yards and gets 45 yards after the catch. Both are great plays for the offense, but I think taps different aspects of receiver talent and scheme. 

The 50-yard catch is part scheme; the right receiver needs to be put in the right route to beat their guy or find the right pocket of the zone. It is also part receiver ability; the receiver needs to get to their spot, either against a corner playing man coverage or settle into the zone, which are both fluid. Then the receiver has to make the catch, which has a myriad of aspects to it that are more fine-grained than I have the data for. I think this inherently taps a receiver's ability to get open and get schemed open. Whereas the play that gets 50 yards because they run 45 yards is also part scheme, but it also speaks to their ability to move in space. These are appreciably different skills and also different roles that they are asked to play in the offense. 
...
As I learned getting the machines working is hard! While they have very similar structures their are unique challenges to each model. As I outlined in the previous section there are a couple different hierarchies 