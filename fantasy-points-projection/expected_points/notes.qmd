...
pass_model = xgb.load('ffopportunity_models/pass_completion.xgb')
rushing_yds = xgb.load('ffopportunity_models/rushing_yards.xgb')
yac = xgb.load('ffopportunity_models/yards_after_catch.xgb')
...
tb_dat = yac_data.select(pl.col('yards_after_catch').median().alias('yac_median'),
